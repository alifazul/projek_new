...
<head>
    ...
    <link href="<?php echo e(asset('admin/css/style5.css')); ?>" rel="stylesheet">
    ...
    <div id="wrapper">
        <div class="nav-set">
            ...
            <ul class="sidebary" id="sidebarcol">
                ...
                <li>
                    <a href="<?php echo e(route('admin.dashboard')); ?>"><i class="fas fa-fw fa-tachometer-alt"></i> Dashboard</a>
                </li>

                <li>
                    <a href="<?php echo e(route('magang.index')); ?>"><i class="fas fa-fw fa-folder"></i> Manajemen Magang</a>
                </li>
                <li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900"><?php echo e($header?? 'Dashboard'); ?></h1>
                        <?php echo $__env->yieldContent('tomboltambah'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\projek_new\resources\views/admin/template.blade.php ENDPATH**/ ?>